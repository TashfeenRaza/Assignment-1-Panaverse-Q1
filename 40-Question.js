...
function make_Album(artist_Name, album_Title, tracks_Album) {
    if (tracks_Album === void 0) { tracks_Album = -1; }
    var Album = {
        artist1: artist_Name,
...
var Album1 = make_Album("ABCD", "ALI ZAFR", 11);
var Album2 = make_Album("TYUIOP", "NOMAN IJAZ", 5);
var Album3 = make_Album("MBMGBDM", "SAJAL ALI");
